...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -O2 -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI} --target=riscv32")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -O2 --gcc-toolchain=${RISCV_TOOLCHAIN_PREFIX} --sysroot=${RISCV_TOOLCHAIN_PREFIX}/${RISCV_TOOLCHAIN_BASENAME}")
