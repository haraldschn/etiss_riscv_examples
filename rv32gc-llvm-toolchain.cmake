...
set(RISCV_ARCH "rv32ima_zicsr_zifencei" CACHE STRING "RISC-V architecture (-march)")
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${OPT_LEVEL} -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI} --target=riscv32")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${OPT_LEVEL} --gcc-toolchain=${RISCV_TOOLCHAIN_PREFIX} --sysroot=${RISCV_TOOLCHAIN_PREFIX}/${RISCV_TOOLCHAIN_BASENAME}")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OPT_LEVEL} -D__riscv__ -march=${RISCV_ARCH} -mabi=${RISCV_ABI} --target=riscv32")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OPT_LEVEL} --gcc-toolchain=${RISCV_TOOLCHAIN_PREFIX} --sysroot=${RISCV_TOOLCHAIN_PREFIX}/${RISCV_TOOLCHAIN_BASENAME}")
